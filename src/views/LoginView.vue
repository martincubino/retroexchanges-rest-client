<template>
    <main class="form-signin">
        <div class="card">
            <b-modal :show="!!error" title="An error occurred" @close="handleError">
                <p>{{ error }}</p>
            </b-modal>
            <b-modal :show="isLoading" title="Authenticating..." fixed>
                <b-spinner></b-spinner>
            </b-modal>
            <div class="card-body m-4 p-4">
                <form @submit.prevent="submitForm">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="password" class="form-control form-control-lg" placeholder="contraseña"
                    ...
                    <b-row>
                        <p v-if="!formIsValid">Introduzca un correo electronico y contraseña válidos (contraseña mayor
                            de 6 carácteres)</p>
                        ...
                        <b-col>
                            <b-button class="btn-secondary btn-lg" @click="switchAuthMode" type="submit">{{switchModeCaption}}
                            </b-button>
                        </b-col>
                    </b-row>
                </form>
